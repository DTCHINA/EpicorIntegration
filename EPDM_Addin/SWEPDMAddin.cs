...
namespace EPDM_Addin
{
    [Guid("78227081-549b-44eb-ab4b-9d6bbe4116d0"), ComVisible(true)]
    public class SWEPDMAddin : IEdmAddIn5
    {
        ...
        void EdmLib.IEdmAddIn5.GetAddInInfo(ref EdmAddInInfo poInfo, IEdmVault5 poVault, IEdmCmdMgr5 poCmdMgr)
        {
            ...
            int edmMenuFlags = (int)EdmMenuFlags.EdmMenu_MustHaveSelection + (int)EdmMenuFlags.EdmMenu_OnlyFiles + (int)EdmMenuFlags.EdmMenu_OnlyInContextMenu + (int)EdmMenuFlags.EdmMenu_OnlySingleSelection;

            poCmdMgr.AddCmd(1, "Read Bill/Cutlist", edmMenuFlags, "", "", 0, 0);
